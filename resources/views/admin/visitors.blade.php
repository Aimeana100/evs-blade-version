...
<div class="main-content container-fluid">
    ...
    <div class=" mt-30">
        ...
        @endphp
         ...
         <div class="card mt-3 bg-blue-100">
            <div class="card-body">
                <h1 class="text-center" > <span class="p-2 border rounded border-cyan-300 text-sky-400" > No Records   {{ request()->has('start_date') ? "for ".request()['start_date']. " to ".request()['end_date'] :"today (". date('Y-m-d') . ") "  }} </span> </h1>
